...
class CollaborativeFilteringRecommender:
    ...
    def recommend_items(self, user_id: int, n_recommendations: int = 10, 
                       exclude_seen: bool = True, ratings_df: pd.DataFrame = None,user_columnName="userId",movie_columnName="movieId",ratings_name="rating") -> List[int]:
        ...
        if exclude_seen and ratings_df is not None:
            user_items = set(ratings_df[ratings_df[user_columnName] == user_id][movie_columnName].values)
